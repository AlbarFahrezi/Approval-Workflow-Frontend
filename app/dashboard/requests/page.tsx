  ...
  */
  ...
  const loadRequests = async () => {
    try {
      ...
      toast.error("Gagal mengambil data requests.");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 py-5 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 grid grid-cols-1 gap-px overflow-hidden rounded-lg border border-slate-200 bg-slate-200 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="bg-white p-5">
            ...
            <p className="mt-1 text-xs text-slate-400">Seluruh pengajuan</p>
          </div>
          ...
          <div className="bg-white p-5">
            <div className="flex items-center justify-between">
              ...
              <FileEdit size={19} className="text-slate-400" />
            </div>
            ...
            <p className="mt-1 text-xs text-slate-400">Belum disubmit</p>
          </div>
          ...
          <div className="bg-white p-5">
            ...
            <p className="mt-1 text-xs text-slate-400">Menunggu approval</p>
          </div>
          ...
          <div className="bg-white p-5">
            ...
            <p className="mt-1 text-xs text-slate-400">Telah disetujui</p>
          </div>
          ...
          <div className="bg-white p-5">
            ...
            <p className="mt-1 text-xs text-slate-400">Ditolak</p>
          </div>
        </div>
        ...
        <div className="rounded-lg border border-slate-200 bg-white">
          ...
          <div className="border-b border-slate-200 bg-white px-5 py-5">
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex flex-wrap items-center gap-2">
                <RequestFilter value={status} onChange={setStatus} />
          ...
          <div className="overflow-x-auto">
            <RequestTable
              ...
              onDetail={(id) => router.push(`/dashboard/requests/${id}`)}
            />
          </div>
        </div>
        ...
        <div className="mb-6 mt-6 grid gap-5 lg:grid-cols-[1fr_340px]">
          {/* STATUS DISTRIBUTION */}
                ...
                {totalRequests > 0 && (
                  <>
                    <div
                      ...
                      style={{
                        width: `${(draftRequests / totalRequests) * 100}%`,
                      }}
                    />
                    <div
                      className="bg-amber-400"
                      style={{
                        width: `${(submittedRequests / totalRequests) * 100}%`,
                      }}
                    />
                    <div
        ...
        <div className="flex items-center justify-between py-5 text-xs text-slate-400">
          ...
          <span>{totalRequests} total records</span>
        </div>
      </div>
    </div>
  );
